...
import tetrominocomputer.Instruction;
import tetrominocomputer.Component;
import tetrominocomputer.HorizontalLine;
import tetrominocomputer.Terminal;
import tetrominocomputer.TerminalType;
...
public class Parser {
    ...
    public String translate(final Map<String, Component> components, final String filename, final String tetrominoScript, 
        ...
        final List<Token> tokens = parseTokens(filename, new ByteArrayInputStream(tetrominoScript.getBytes()));
