...
import tetrominocomputer.BuildListener;
...
public class CircuitsFrame extends javax.swing.JFrame {
    ...
    private String getComponentDirectory() {
        if (circuitsDirectory == null) {
            circuitsDirectory = System.getProperty("user.dir") + File.separator + Controller.TS_DIR;
    ...
    private void initComponents() {
        ...
        circuitsEditorPanel = new tetrominocomputer.ui.CircuitsEditorPanel();
    ...
    private tetrominocomputer.ui.CircuitsEditorPanel circuitsEditorPanel;
