...
public class GenerateTransducer {
    ...
    public void launch() throws Exception {
        ...
        for (int i = 0; i < L; ++i) {
            ...
            cells[i + N].setCellType(CellType.MODIFIED_TAPE);
            cells[i + N].setValue(cells[i + N].getValue() << 4);
