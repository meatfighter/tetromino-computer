...
public class GenerateInstructionDetectors {
    ...
    private void saveTS(final String name, final int opcode) throws Exception {
        ...
        saveFile(String.format("workspace/computer/%s_C.t", name), tsLines);
    }
    ...
    private void saveJS(final String name, final int opcode) throws Exception {
        ...
        saveFile(String.format("workspace/computer/%s_C.js", name), jsLines);
    }    
    ...
    private void loadJavaScript() throws Exception {
        try (final BufferedReader br = new BufferedReader(new FileReader("workspace/computer/ZERO_C.js"))) {
            int lineNumber = 0;
            String line = null;
    ...
    private void loadTetrisScript() throws Exception {
        try (final BufferedReader br = new BufferedReader(new FileReader("workspace/computer/ZERO_C.t"))) {
            int lineNumber = 0;
            String line = null;
            while ((line = br.readLine()) != null) {
                tsLines.add(line);
