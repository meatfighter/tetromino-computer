...
public class SvgGenerator {
    ...
    public void generate(
        ...
        try (final PrintStream o = new PrintStream(out)) {
            generate(o, struct, displayWidth, margin, cellSize, renderGrid, renderInputTerminals, renderOutputTerminals, 
                    renderTetriminos, renderYAxis, renderStructures, renderAxesNumbers, renderTerminalValues,
                    leftPaddingCells, rightPaddingCells, topPaddingCells);
        }
    }
    ...
    private void generate(
        ...
        final double gridY = margin + (renderTerminalValues ? cellSize : 0);
        final double viewBoxWidth = gridX + gridWidth + margin;
        final double viewBoxHeight = gridY + gridHeight + margin + (renderTerminalValues ? cellSize : 0)
